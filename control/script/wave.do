...
add wave -noupdate :tb_control:dut:replay_addr_o
add wave -noupdate :tb_control:dut:done
add wave -noupdate :tb_control:dut:state
add wave -noupdate :tb_control:dut:done_tmp
add wave -noupdate :tb_control:dut:temp
add wave -noupdate :tb_control:dut:addr_tmp
add wave -noupdate :tb_control:dut:addr
