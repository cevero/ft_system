...
add wave -noupdate -radix decimal :tb_control:dut:replay_addr_o
add wave -noupdate :tb_control:dut:done
add wave -noupdate :tb_control:dut:state
add wave -noupdate -radix decimal :tb_control:dut:temp
add wave -noupdate -radix decimal :tb_control:dut:addr
